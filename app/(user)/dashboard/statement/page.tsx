        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button
                    ...
                    className="btn-primary bg-red-700 hover:bg-red-800 flex items-center gap-2 px-5 py-2.5 text-sm font-bold self-start"
                >
                    {downloading ? (
            ...
            <div className="card p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
                    ...
                    <div><span className="text-gray-500 font-semibold">{t("dashboard.statement.status")}:</span>
                        <span className={`font-bold ${ac.status === "ACTIVE" ? "text-red-700" : "text-red-600"}`}> {ac.status === "ACTIVE" ? t("dashboard.statement.active") : t("dashboard.statement.inactive")}</span>
                    </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                {[
                    { label: t("dashboard.statement.totalBalance"), value: ac.walletBalance, icon: Wallet, color: "text-red-700 bg-red-50" },
                    ...
                    { label: t("dashboard.statement.withdrawable"), value: ac.withdrawable, icon: Wallet, color: "text-red-700 bg-red-50" },
                ].map((item) => (
            ...
            <div className="card p-5">
                <h3 className="text-sm font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100 flex items-center gap-2">
                    <Wallet size={16} className="text-red-700" />
                        ...
                        <table className="w-full text-xs">
                            ...
                            <tbody>
                                {data.transactions.map((tx, i) => (
                                    <tr key={tx.id} className={i % 2 === 0 ? "bg-red-50/30" : ""}>
                                        ...
                                        <td className={`px-3 py-2 text-right font-bold ${Number(tx.amount) >= 0 ? "text-red-700" : "text-red-600"}`}>
                                            {formatCurrency(tx.amount, locale)}
                                        </td>
                        ...
                        <table className="w-full text-xs">
                            ...
                            <tbody>
                                {data.withdrawals.map((w, i) => (
                                    <tr key={w.id} className={i % 2 === 0 ? "bg-red-50/30" : ""}>
                                        ...
                                        <td className="px-3 py-2">
                                            <span className={`inline-block px-2 py-0.5 rounded-full text-[10px] font-bold ${
                                                w.status === "APPROVED" ? "bg-red-100 text-red-800" :
