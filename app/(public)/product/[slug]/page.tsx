            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 bg-white card-flat p-6 lg:p-10">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="mt-2 mb-6">
                        <span className="text-3xl font-extrabold text-emerald-600">{formatCurrency(product.price, locale)}</span>
                    ...
                    {product.stock > 0 ? (
                        ...
                        <div className="rounded-xl border-2 border-green-100 bg-green-50 p-6 text-center text-sm font-bold text-green-600">
