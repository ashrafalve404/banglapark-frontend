                                                ...
                                                <tbody className="divide-y divide-slate-100">
                                                    {statementData.transactions.map((tx: any) => (
                                                        <tr key={tx.id} className="hover:bg-slate-50">
                                                            ...
                                                            <td className={`p-2.5 text-right font-semibold ${Number(tx.amount) >= 0 ? "text-green-700" : "text-red-600"}`}>
                                                                ৳{tx.amount}
                                                            </td>
                                                ...
                                                <tbody className="divide-y divide-slate-100">
                                                    {statementData.withdrawals.map((w: any) => (
                                                        <tr key={w.id} className="hover:bg-slate-50">
                                                            ...
                                                            <td className="p-2.5">
                                                                <span className={`inline-block rounded-full px-2 py-0.5 text-[10px] font-semibold ${w.status === "APPROVED" ? "bg-green-100 text-green-800" : w.status === "REJECTED" ? "bg-red-100 text-red-800" : "bg-amber-100 text-amber-800"}`}>
                                                                    {w.status}
                                                                </span>
                                                            </td>
                                                        </tr>
