...
export function LocaleSwitcher({ light }: { light?: boolean }) {
    ...
    return (
        <button
            ...
            className={`flex items-center gap-0.5 sm:gap-1 rounded-lg border px-1.5 sm:px-2 py-1 text-[10px] sm:text-xs font-medium transition-colors ${light ? "border-white/30 text-white/85 hover:bg-white/10 hover:text-white" : "border-gray-200 text-gray-800 hover:bg-gray-100"}`}
