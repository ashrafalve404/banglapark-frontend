...
export function DashboardSidebar({ onClose, mobile }: DashboardSidebarProps) {
    ...
    const navItems = [
        ...
        { href: "/shop", label: t("nav.products"), icon: FaBoxOpen, activeBg: "bg-emerald-50 text-emerald-800 border-l-4 border-emerald-600 shadow-xs", iconColor: "text-emerald-600" },
        ...
        { href: "#", label: t("nav.buyProduct"), icon: FaCartShopping, activeBg: "bg-orange-50 text-orange-800 border-l-4 border-orange-600 shadow-xs", iconColor: "text-orange-600" },
