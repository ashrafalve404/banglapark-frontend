...
export function AdminSidebar({ onClose, mobile }: AdminSidebarProps) {
    ...
    const navItems = [
        ...
        { href: "#", label: t("nav.buyProduct"), icon: FaCartShopping, activeBg: "bg-orange-500/20 text-orange-300 border-l-4 border-orange-500 font-bold", iconColor: "text-orange-400" },
        ...
        { href: "#", label: t("nav.cpaMarketing"), icon: FaRectangleAd, activeBg: "bg-purple-500/20 text-purple-300 border-l-4 border-purple-500 font-bold", iconColor: "text-purple-400" },
        ...
        { href: "#", label: t("nav.marketingExpense"), icon: FaReceipt, activeBg: "bg-amber-500/20 text-amber-300 border-l-4 border-amber-500 font-bold", iconColor: "text-amber-400" },
    ];
        ...
        <aside className={cn("flex h-full flex-col bg-slate-900", mobile && "")}>
                        ...
                        <Link
                            ...
                            className={cn(
                                ...
                                active
                                    ? item.activeBg
                                    : isPlaceholder
                                    ? "text-slate-500 hover:bg-slate-800/50 hover:text-slate-400 cursor-default"
                                    : "text-slate-400 hover:bg-slate-800 hover:text-slate-200"
                            )}
                        >
                            <Icon size={17} className={active ? item.iconColor : isPlaceholder ? "text-slate-600" : "text-slate-400"} />
                            {item.label}
            ...
            <div className="border-t border-slate-700 p-3 space-y-2">
                <button
                    ...
                    className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-red-400 hover:bg-slate-800 transition-all cursor-pointer"
                >
